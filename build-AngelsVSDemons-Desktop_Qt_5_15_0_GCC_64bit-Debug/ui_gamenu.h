...
public:
    ...
    void setupUi(QDialog *GAMenu)
    {
        ...
        label->setGeometry(QRect(130, 70, 521, 141));
        label->setPixmap(QPixmap(QString::fromUtf8("../ImagenesGUI/heavenT.png")));
        screen = new QTextEdit(GAMenu);
        screen->setObjectName(QString::fromUtf8("screen"));
        screen->setGeometry(QRect(570, 210, 821, 521));
        familyState = new QPushButton(GAMenu);
        familyState->setObjectName(QString::fromUtf8("familyState"));
        familyState->setGeometry(QRect(230, 384, 231, 51));
        secondName = new QLabel(GAMenu);
        secondName->setObjectName(QString::fromUtf8("secondName"));
        secondName->setGeometry(QRect(160, 340, 67, 17));
        QPalette palette;
...
#endif
        secondName->setPalette(palette);
        hLS = new QPushButton(GAMenu);
        hLS->setObjectName(QString::fromUtf8("hLS"));
        hLS->setGeometry(QRect(230, 450, 231, 51));
        CFS = new QPushButton(GAMenu);
        CFS->setObjectName(QString::fromUtf8("CFS"));
        CFS->setGeometry(QRect(230, 510, 231, 51));
        Pais = new QTextEdit(GAMenu);
        Pais->setObjectName(QString::fromUtf8("Pais"));
        Pais->setGeometry(QRect(240, 280, 221, 31));
        pais = new QLabel(GAMenu);
        pais->setObjectName(QString::fromUtf8("pais"));
        pais->setGeometry(QRect(160, 290, 67, 17));
        QPalette palette1;
        ...
        IDSig = new QLabel(GAMenu);
        IDSig->setObjectName(QString::fromUtf8("IDSig"));
        IDSig->setGeometry(QRect(170, 240, 67, 17));
        QPalette palette2;
...
#endif
        IDSig->setPalette(palette2);
        sencondN = new QTextEdit(GAMenu);
        sencondN->setObjectName(QString::fromUtf8("sencondN"));
        sencondN->setGeometry(QRect(240, 330, 221, 31));
        id = new QTextEdit(GAMenu);
        id->setObjectName(QString::fromUtf8("id"));
        id->setGeometry(QRect(240, 240, 221, 31));
